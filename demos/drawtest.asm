...
* --------------
phobyx_pal
	DP 000,574,434,555,656,799,A9A,BCC,DCD,EFF,FAF,695,9B7,7A6,AAB,AC9
...
* --------------
 ...
 IFD USE_POLY8
	include <includes/fpolygon8.inc>
 ELSE
